    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center personalizado">Dámaris Francini Huertas Fernandez <br></br> ¿Quieres ser mi San Valentin?</h1>
          ...
          <div className="flex justify-center items-center flex-col space-y-10">
            <h1 className="text-4xl text-white font-bold personalizado personalizado-2">Sabia que dirias que si 🥰!<br></br>Te amo mi amor ❤️</h1>
